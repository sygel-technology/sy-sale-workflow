...
class Picking(models.Model):
    ...
    def send_email_to_client(self):
        for sel in self:
            ...
            if mail_template:
                ...
                # asignado.
                if sel.partner_id.id in mail_wizard.partner_ids.ids and (sel.partner_id.email is False or sel.partner_id.email == ''):
    ...
    def action_done(self):
        ...
        for sel in self.filtered(
            lambda a: a.picking_type_id.code == 'outgoing' and
            a.sale_id and a.sale_contact_id.receive_confirmation_mails and
            a.sale_id.type_id.send_confirmation_mails
        ):
