...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        if self.route_id.deposit_operation and \
           self.route_id.deposit_operation_type == 'delivery_deposit':
            res["discount"] = 100.0
        return res
    ...
    def write(self, values):
        ...
        if route_id and route_id.deposit_operation and \
           route_id.deposit_operation_type == 'delivery_deposit':
    ...
    def _onchange_route_id(self):
        for sel in self:
            res = 0.0
            if sel.route_id and \
               sel.route_id.deposit_operation and \
               sel.route_id.deposit_operation_type == 'delivery_deposit':
                res = 100.0
            sel.discount = res
    ...
    def _compute_invoice_status(self):
        ...
        for line in self.filtered(lambda x: x.route_id and x.route_id.deposit_operation and x.route_id.deposit_operation_type == 'delivery_deposit'):
    ...
    def _get_outgoing_incoming_moves(self):
        ...
        if self.route_id and \
           self.route_id.deposit_operation and \
           self.route_id.deposit_operation_type == 'delivery_deposit':
            for move in moves:
