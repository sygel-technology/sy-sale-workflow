...
class Warehouse(models.Model):
    ...
    def _get_vals_deposit_operation_type(self, warehouse, return_picking_id=False, deposit=False):
        name = _("({}) Deposit Sale").format(warehouse.name)
        code = 'incoming'
        sequence_code = "{}/DEP_SALE/".format(warehouse.code)
        print_label = False
        ...
        if return_picking_id and deposit:
            ...
            code = 'outgoing'
            sequence_code = "{}/DEL_DEP/".format(warehouse.code)
            print_label = True
